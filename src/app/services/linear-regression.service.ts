...
export class LinearRegressionService {
  ...
  test1 = 'https://node-api2023-service-yodoeaoffi06.cloud.okteto.net/test1';
  test2 = 'https://node-api2023-service-yodoeaoffi06.cloud.okteto.net/test2';
  test3 = 'https://node-api2023-service-yodoeaoffi06.cloud.okteto.net/test3';
  test4 = 'https://node-api2023-service-yodoeaoffi06.cloud.okteto.net/test4';
